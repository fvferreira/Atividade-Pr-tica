Programa em C que solicita um número inteiro maior que 1 e exibe todos os números primos menores que ele. O código utiliza funções, estruturas de decisão e repetição.
